...
export type Banner = { id: string; img: string; link?: string };
export type EventCard = {
  id: string; title: string; poster: string;
  city: string; venue: string; date: string; time: string;
  priceFrom: number; status: "onSale" | "upcoming" | "soldOut";
};
export type MerchCard = { id: string; title: string; img: string; price: number };

export type HomePayload = {
  banners: Banner[];
  upcoming: EventCard[];
  recommended?: EventCard[];
  upcomingSale?: EventCard[];
  merch?: MerchCard[];
};
